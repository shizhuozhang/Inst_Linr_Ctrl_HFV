...
Rad2Deg = 180 / My_PI; 
 ...
 Dlt_e0 = CtrlData(:,11);   e_alp0 = CtrlData(:,14); 
% load FltData2_CNC.mat;
% Dlt_e0 = FltData2(1:10000,21); e_alp0 = FltData2(1:10000,24); % Ero_qw1 = CtrlData(:,17);   

%%普通PID控制
load NNadpData_D_off_pid.mat;  
T = NNadpData(:,1);  
e_alp1 = NNadpData(:,14);  eC_SldSum1 = NNadpData(:,19);  

%%自适应pid
load NNadpData_D_on_adp.mat;   
